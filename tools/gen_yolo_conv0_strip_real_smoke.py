...
SP_OUT = OUT_W * OUT_H
STRIP_OUT_ROWS = 8
STRIP_OUT_WORDS = OUT_W * STRIP_OUT_ROWS
STRIP_TEST_COUNT = OUT_H // STRIP_OUT_ROWS
KO = KH * KW
Q_SHIFT = 20
...
#define YOLO_CONV0_STRIP_OUT_WORDS_PER_STRIP {STRIP_OUT_WORDS}u
#define YOLO_CONV0_STRIP_TEST_COUNT {STRIP_TEST_COUNT}u
